...
public class CalculadoraModular2 {
	
	private static int tipoOperacion;
	private static int operacion;
	private static int operandoA;
	private static int operandoB;
	...
	private static int hacerSuma(int a, int b) {//metodo suma
		return a + b;
	}
	
	private static int hacerResta(int a, int b) {//metodo resta
		return a - b;
	}
	
	private static int hacerMultiplicacion(int a, int b) {//metodo multiplicacion
		return a * b;
	}
	
	private static int hacerDivision(int a, int b) {//metodo division
		return a / b;
	}
	...
	private static void mostrarResultadoAritmetico() {//metodo que muestra el resultado de la operacion aritmetica elegida
		...
		case 4:
			try {
				System.out.println(hacerDivision(operandoA, operandoB));
			}
